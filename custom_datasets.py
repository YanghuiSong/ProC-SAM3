# Register custom datasets here for segmentation tasks
# This file helps MMEngine recognize custom datasets in the project
# All custom dataset classes should be decorated with @DATASETS.register_module()
...
# Note: ISPRSDataset is already registered in mmseg.datasets, so we don't need to register it here
# class ISPRSDataset(BaseSegDataset):
#     """ISPRS Potsdam/Vaihingen dataset.
#
#     """
#     METAINFO = dict(
