# Controlled config for Vaihingen dataset using preset optimization
...
model = dict(
    ...
    optimize_method='hybrid_strict',  # "adaptive" or "guided" or "preset"
    prob_thd=0.1,
    bg_idx=5,
    confidence_threshold=0.4,
    use_sem_seg=True,
    use_presence_score=True,
    use_transformer_decoder=False,  # False True, but True seems to help Vaihingen more than other datasets
    slide_stride=0,
    slide_crop=0,
