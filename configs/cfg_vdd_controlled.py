# Controlled config for VDD dataset using hybrid_strict prompt optimization.
# Keep the same cached-segmentor logic as UDD5 because both are UAV datasets.
...
# Class names for VDD dataset
class_names = [
    'background', 'facade', 'road', 'vegetation', 'vehicle', 'roof', 'water'
]
...
model = dict(
    ...
    use_transformer_decoder=False,  # True or False
    slide_stride=0,
    slide_crop=0,
    prompt_batch_size=2,
    image_batch_size=1,
