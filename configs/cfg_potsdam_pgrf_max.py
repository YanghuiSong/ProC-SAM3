# Config for Potsdam dataset using PGRF max aggregation
...
# Class names for Potsdam dataset
class_names = [
...
model = dict(
    ...
    expanded_prompt_pool_path='./prompt_pools/cfg_potsdam_pgrf_max_expanded_prompt_pool_hybrid_strict.pkl',
...
# Work directory
work_dir = './work_dirs/cfg_potsdam_pgrf_max'
