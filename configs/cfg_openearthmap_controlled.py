# Controlled config for OpenEarthMap dataset using hybrid_strict prompt optimization
...
# Class names for OpenEarthMap dataset
class_names = [
...
model = dict(
    ...
    class_aggregation='max',  # max consensus_gem
