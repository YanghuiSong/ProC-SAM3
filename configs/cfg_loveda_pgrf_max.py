# Config for LoveDA dataset using PGRF max aggregation
...
model = dict(
    ...
    expanded_prompt_pool_path='./prompt_pools/cfg_loveda_pgrf_max_expanded_prompt_pool_hybrid_strict.pkl',
...
# Work directory
work_dir = './work_dirs/cfg_loveda_pgrf_max'
